...
def cli(vegas_st2_file,output_file,nevt,debug):
    if(debug):
    ...
    ext = image_extractor.ImageExtractor(output_file,storage_mode="tel_type",img_mode="1D",force_all_telescopes=False)
